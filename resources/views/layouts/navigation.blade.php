<nav x-data="{ open: false }" class="bg-cyan-600 border-b border-cyab-700">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        ...
                        <img src="{{ asset('img/ilmuwanTop.png') }}" alt="Logo Ilmuwan Top" class="block h-10 w-auto">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @can('manage-content')
                    <x-nav-link :href="route('menkos.index')" :active="request()->routeIs('menkos.*')">
                        {{ __('Manajemen Konten') }}
                    </x-nav-link>
                    @endcan
                    ...
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            ...
                            <div class="me-2">
                                ...
                                @else
                                    {{-- Jika tidak ada avatar, tampilkan inisial nama dengan latar belakang berwarna --}}
